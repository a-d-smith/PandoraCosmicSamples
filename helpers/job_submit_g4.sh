...
echo "Running: project.py --xml $WORKING_DIR/projects/$project/$nuance/prod_chain_$nuance.xml --stage g4 --submit"
project.py --xml $WORKING_DIR/projects/$project/$nuance/prod_chain_$nuance.xml --stage g4 --submit
