...
echo "Running: project.py --xml $WORKING_DIR/projects/$project/$nuance/prod_chain_$nuance.xml --stage gen --clean"
project.py --xml $WORKING_DIR/projects/$project/$nuance/prod_chain_$nuance.xml --stage gen --clean
